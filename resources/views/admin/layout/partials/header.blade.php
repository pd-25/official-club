    ...
    <nav class="navbar navbar-expand-md">
        ...
        <div class="navbar-header d-flex align-items-center">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="{{asset('adminassets/img/logo.png')}}" class="img-fluid logo-desktop" alt="logo" />
                <img src="{{asset('adminassets/img/logo-icon.png')}}" class="img-fluid logo-mobile" alt="logo" />
            </a>
        </div>
                ...
                <ul class="navbar-nav nav-right ml-auto">
                    <li class="nav-item dropdown user-profile">
                        <a href="javascript:void(0)" class="nav-link dropdown-toggle "
                            ...
                            <img src="{{asset('adminassets/img/avtar/02.jpg')}}" alt="avtar-img">
