...
<section id="facilities-section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 faciBox">
                <div class="hmBox-img"> <img src="{{ asset('asset/images/fac-icon3.png') }}" class="img-fluid"> </div>
                <div class="hmBox-ctn">
                    <h3>Library Room</h3>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 faciBox">
                <div class="hmBox-img"> <img src="{{ asset('asset/images/fac-icon4.png') }}" class="img-fluid"> </div>
                <div class="hmBox-ctn">
            ...
            <div class="col-lg-4 col-md-6 faciBox">
                <div class="hmBox-img"> <img src="{{ asset('asset/images/fac-icon5.png') }}" class="img-fluid"> </div>
                <div class="hmBox-ctn">
                    <h3>TV Lounge</h3>
            ...
            <div class="col-lg-4 col-md-6 faciBox">
                <div class="hmBox-img"> <img src="{{ asset('asset/images/fac-icon6.png') }}" class="img-fluid"> </div>
                <div class="hmBox-ctn">
                    <h3>Gynasium</h3>
...
<section id="sports-section" class="parallax-window" data-parallax="scroll" data-image-src="{{ asset('asset/images/bg-img.jpg') }}">
    <div class="container">
        <div class="row mb-3">
            <div class="col-lg-12">
                <h1>Sports</h1>
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-lg-6 event-img">
                                    <img src="{{ asset('asset/images/event-pic.jpg') }}" class="img-fluid">
                                </div>
                                <div class="col-lg-6 event-ctn">
                                    <p class="epost-date"><span>June 01, 2020</span><span> / 12P/M. - 4P.M.</span>
                                    </p>
                                    <h2>Rabindranath Tagore Birthday</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin efficitur
                                        lobortis nisl, sit amet bibendum metus sodales a. Cras porttitor a nisi non
                                        auctor. Donec eu orci eleifend, mollis enim non, scelerisque augue
                                        pellentesque non leo auctor.</p>
                                    <p>Proin efficitur lobortis nisl, sit amet bibendum metus sodales a. Cras
                                        porttitor a nisi non auctor. Donec eu orci eleifend, mollis enim non.</p>
                                    <a class="rmBtn" href="">Read More</a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12 mb-4">
                <div id="demo-pranab">
                    <div id="owl-gallery" class="owl-carousel owl-theme">
                        <div class="item">
                            <img src="{{ asset('asset/images/gallery/gal-pic1.jpg') }}" class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="{{ asset('asset/images/gallery/gal-pic2.jpg') }}" class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="{{ asset('asset/images/gallery/gal-pic3.jpg') }}" class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="{{ asset('asset/images/gallery/gal-pic4.jpg') }}" class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="{{ asset('asset/images/gallery/gal-pic1.jpg') }}" class="img-fluid">
                        </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a class="rmBtn" href="gallery.html">View Gallery</a>
            </div>
        </div>
